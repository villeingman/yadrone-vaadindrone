...
public class KeyboardCommandManagerAlternative extends KeyboardCommandManager {
	...
	protected void handleCommand(int key, int mod) {
		...
		case KeyEvent.VK_V:
			...
			break;
		case KeyEvent.VK_B:
			VegasDroneUtils.doLedsAnimation(drone);
//			drone.toggleCamera();
...
//			drone.getCommandManager().animate(FlightAnimation.PHI_30_DEG);
		...
		case KeyEvent.VK_F4:
			...
			break;
		case KeyEvent.VK_F5:
			drone.getCommandManager().animate(
					FlightAnimation.THETA_20DEG_YAW_200DEG);
			break;
		case KeyEvent.VK_F6:
			drone.getCommandManager().animate(
					FlightAnimation.THETA_20DEG_YAW_M200DEG);
			break;
		case KeyEvent.VK_F7:
		...
		case KeyEvent.VK_F8:
			drone.getCommandManager()
					.animate(FlightAnimation.TURNAROUND_GODOWN);
			break;
		case KeyEvent.VK_F9:
			drone.getCommandManager().animate(FlightAnimation.YAW_SHAKE);
			break;
		...
		case KeyEvent.VK_6:
			drone.getCommandManager().animate(
					FlightAnimation.DOUBLE_PHI_THETA_MIXED);
			break;
		case KeyEvent.VK_7:
